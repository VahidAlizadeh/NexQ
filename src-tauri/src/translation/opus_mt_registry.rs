...
static OPUS_MT_MODELS: &[OpusMtModelDefinition] = &[
    ...
    OpusMtModelDefinition {
        ...
        target_name: "Farsi",
        size_bytes: 310_000_000,
        encoder_url: "https://huggingface.co/Xenova/opus-mt-en-fa/resolve/main/onnx/encoder_model.onnx",
        decoder_url: "https://huggingface.co/Xenova/opus-mt-en-fa/resolve/main/onnx/decoder_model_merged.onnx",
        tokenizer_url: "https://huggingface.co/Xenova/opus-mt-en-fa/resolve/main/tokenizer.json",
        config_url: "https://huggingface.co/Xenova/opus-mt-en-fa/resolve/main/config.json",
        quality_rating: 3,
    },
    // ── X → English ──
    OpusMtModelDefinition {
        ...
        target_name: "English",
        size_bytes: 310_000_000,
        encoder_url: "https://huggingface.co/Xenova/opus-mt-fa-en/resolve/main/onnx/encoder_model.onnx",
        decoder_url: "https://huggingface.co/Xenova/opus-mt-fa-en/resolve/main/onnx/decoder_model_merged.onnx",
        tokenizer_url: "https://huggingface.co/Xenova/opus-mt-fa-en/resolve/main/tokenizer.json",
        config_url: "https://huggingface.co/Xenova/opus-mt-fa-en/resolve/main/config.json",
        quality_rating: 3,
    },
    OpusMtModelDefinition {
